...
```
docker exec -it MyBooks bash
python3 /data/books/calibre-webserver.py --username admin --password newpassword
```

替换 `newpassword` 为您的新密码，然后重启容器。
