...
### 使用浏览器扩展快速查询和导入
在浏览器安装MyBooks Extension后，配置MyBooks连接。以后浏览网站时可以在页面直接查询书库是否存在某本书，并可以快速上传。
扩展地址：[MyBooks Chrome Extension](https://github.com/PoxenStudio/extensions/releases)。
详情参考: [MyBooks扩展帮你快速查询书库中已有存书](http://zhuanlan.zhihu.com/p/2043382558646326060)。
...
详情页“管理”中可以地行格式转换，以及导出A5 PDF（用于AI知识库）。
...
在系统配置开启Podcast服务后，可以使用播客客户端连接到MyBooks的Podcast服务(`http://<mybooks host>/podcast`)订阅播放。
详情见：[一键搞定电子书转有声书并以播客分享](https://zhuanlan.zhihu.com/p/2041104403185329787)。
...
在你的AI工具中直接安装，或者下载zip进行安装，然后配置mybooks服务器地址及账号密码，即可正常使用。包括搜索、下载、上传、更新元数据、导入批注数据等。
示例：[将微信读书的笔记导入到你的个人书库](https://zhuanlan.zhihu.com/p/2071531924817023519)。
...
在系统设置-浏览与阅读中选择阅读器。推荐使用 MyReader，完整的阅读功能，自动进行书评数据同步。
...
## 多人阅读
支持书评、批注及划线的多人分享，达到多人阅读的能力。同时在首页可以查看另人新评的书籍。
详情见：[支持多人共读的个人电子书库](https://zhuanlan.zhihu.com/p/2071529162829992969)
